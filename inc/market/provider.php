 ...
 * crypto if CoinGecko cannot produce a valid payload. Migrated currency and
 * gold do not fall back to the parent transport because the child BirTema
...
function pv_market_provider_fetch( $resource ) {
    ...
    if ( in_array( $resource, array( 'currency', 'altin' ), true ) ) {
